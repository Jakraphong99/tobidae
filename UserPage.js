...
const UserPage = ({ route }) => {
  ...
  const isFocused = useIsFocused(); // เช็คว่าหน้าปัจจุบันถูกโฟกัสหรือไม่
  ...
  useEffect(() => {
    const backAction = () => {
      if (isFocused && navigation.getState().routes[navigation.getState().index].name === "Home") {
        // แสดงการยืนยันเมื่ออยู่ที่หน้า Home
      ...
      return false; // ให้ทำการย้อนกลับตามปกติถ้าไม่ใช่หน้า Home
    };
